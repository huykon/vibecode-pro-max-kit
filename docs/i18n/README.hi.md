...
Agent सिर्फ आपका code नहीं पढ़ता — यह **दूसरे repositories study करता है** यह जानने के लिए कि उन्होंने similar problems कैसे solve किए (`vc-docs-seeker`)।
...
किसी भी request को route करने से पहले, <strong>33 skills</strong> scan करता है और keywords match करता है। "add webhook support" कहें और <code>vc-security</code> + <code>vc-scenario</code> automatically surface हो जाते हैं।
</td>
<td width="50%" valign="top">
<h1>💾</h1>
