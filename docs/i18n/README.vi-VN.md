...
your-project/
├── .claude/
│   ├── agents/              # 🤖 15 agent definitions chuyên biệt
│   │   ├── vc-research-agent.md
│   │   ├── vc-execute-agent.md
│   │   └── ...
│   ├── skills/              # ⚡ 33 skills tự động discover
│   │   ├── vc-generate-plan/
│   │   ├── vc-security/
│   │   ├── vc-scout/
│   │   └── ...
...
Bộ harness này cài đặt một hệ thống development hoàn chỉnh vào project của bạn — không chỉ một file CLAUDE.md, mà là **15 agents chuyên biệt, 33 skills**, và một workflow phase-locked buộc agent phải **hiểu trước khi build**.
...
Agent không chỉ đọc code của bạn — nó **nghiên cứu các repositories khác** để học cách họ giải quyết vấn đề tương tự (`vc-docs-seeker`).
...
Trước khi route bất kỳ request nào, scan <strong>33 skills</strong> và match keywords. Nói "add webhook support" và <code>vc-security</code> + <code>vc-scenario</code> tự động surface.
</td>
<td width="50%" valign="top">
<h1>💾</h1>
